                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-control @error('ambulans_id') is-invalid @enderror"
                                    id="ambulans_id" name="ambulans_id" required>
                                @foreach($ambulans as $a)
                                    <option value="{{ $a->id }}" {{ $item->ambulans_id == $a->id ? 'selected' : '' }}>
                                        {{ $a->nopol }} - {{ $a->merk }} ({{ $a->tahun }})
                                    </option>
                                @endforeach
                            </select>
                            @error('ambulans_id')
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control @error('status_perjalanan') is-invalid @enderror"
                                ...
                                <option value="berjalan" {{ $item->status_perjalanan == 'berjalan' ? 'selected' : '' }}>Berjalan</option>
                                <option value="selesai" {{ $item->status_perjalanan == 'selesai' ? 'selected' : '' }}>Selesai</option>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control @error('waktu_berangkat') is-invalid @enderror"
                                   id="waktu_berangkat" name="waktu_berangkat"
                                   value="{{ old('waktu_berangkat', \Carbon\Carbon::parse($item->waktu_berangkat)->format('Y-m-d\TH:i')) }}" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('keperluan') is-invalid @enderror"
                                      id="keperluan" name="keperluan" rows="2" required>{{ old('keperluan', $item->keperluan) }}</textarea>
                            @error('keperluan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('km_kembali') is-invalid @enderror"
                                   id="km_kembali" name="km_kembali"
                                   value="{{ old('km_kembali', $item->km_kembali) }}">
                            @error('km_kembali')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('catatan') is-invalid @enderror"
                                      id="catatan" name="catatan" rows="2">{{ old('catatan', $item->catatan) }}</textarea>
                            @error('catatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
