<!-- Modal Edit Ambulans -->
<div class="modal fade" id="editAmbulansModal{{ $ambulan->id }}" tabindex="-1"
    aria-labelledby="editAmbulansModalLabel{{ $ambulan->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="editAmbulansModalLabel{{ $ambulan->id }}">Edit Data Ambulans</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <form method="POST" action="{{ route('ambulans.update', $ambulan->id) }}">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                            ...
                            <select class="form-select @error('puskesmas_id') is-invalid @enderror" id="puskesmas_id"
                                ...
                                @foreach ($puskesmas as $puskesma)
                                    <option value="{{ $puskesma->id }}"
                                        {{ old('puskesmas_id', $ambulan->puskesmas_id) == $puskesma->id ? 'selected' : '' }}>
                                        {{ $puskesma->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_polisi') is-invalid @enderror"
                                ...
                                value="{{ old('nomor_polisi', $ambulan->nomor_polisi) }}" required>
                            @error('nomor_polisi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('merk') is-invalid @enderror"
                                id="merk" name="merk" value="{{ old('merk', $ambulan->merk) }}" required>
                            @error('merk')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('tahun') is-invalid @enderror"
                                id="tahun" name="tahun" value="{{ old('tahun', $ambulan->tahun) }}"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_mesin') is-invalid @enderror"
                                ...
                                value="{{ old('nomor_mesin', $ambulan->nomor_mesin) }}" required>
                            @error('nomor_mesin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_rangka') is-invalid @enderror"
                                ...
                                value="{{ old('nomor_rangka', $ambulan->nomor_rangka) }}" required>
                            @error('nomor_rangka')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status"
                                ...
                                <option value="standby"
                                    {{ old('status', $ambulan->status) == 'standby' ? 'selected' : '' }}>Standby
                                </option>
                                <option value="dinas"
                                    {{ old('status', $ambulan->status) == 'dinas' ? 'selected' : '' }}>Dinas</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('km_terakhir') is-invalid @enderror"
                                id="km_terakhir" name="km_terakhir"
                                value="{{ old('km_terakhir', $ambulan->km_terakhir) }}" min="0" required>
                            @error('km_terakhir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan"
                            rows="3">{{ old('keterangan', $ambulan->keterangan) }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
